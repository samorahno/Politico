...
class ValidateCreateUser {
  ...
  static validateCreate(req, res, next) {
    if (!req.body.firstname || !req.body.lastname || !req.body.email || !req.body.phone || !req.body.password || !req.body.confirmPassword) {
    ...
    if (!validator.validateString(req.body.firstname) || !validator.validateString(req.body.othername) || !validator.validateString(req.body.lastname)) {
      return res.status(400).send({ status: 400, error: 'Name Is Invalid' });
    }
